...
class LeggingsCosmetic extends ArmorCosmetic
{
    public function __construct(int $saveId, CosmeticHandler $handler)
    {
        parent::__construct(ArmorInventory::SLOT_LEGS, $saveId, $handler);
    }
    ...
    {
        return "animation.ng.lobby.crate.leggings";
    }

    public function getButton(Player $player, Closure $callable): Button
    {
        return new ImageButton(SimpleForm::BUTTON_TAB . $this->getName(), ImageButton::IMAGE_TYPE_PATH, 'textures/items/iron_leggings', $callable);
    }
}