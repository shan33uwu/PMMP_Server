...
class TeamCagesCosmetic extends CagesCosmetic
{
    ...
    {
        return 'animation.ng.lobby.crate.team_cage';
    }
    ...
    {
        return new ImageButton(SimpleForm::BUTTON_TAB . $this->getName(), ImageButton::IMAGE_TYPE_PATH, 'textures/ui/ng/tabs/cageduo', $callable);
    }
}