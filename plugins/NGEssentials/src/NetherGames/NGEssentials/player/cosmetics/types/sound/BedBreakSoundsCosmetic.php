...
namespace NetherGames\NGEssentials\player\cosmetics\types\sound;

use Closure;
use libforms\elements\Button;
use libforms\elements\ImageButton;
use libforms\SimpleForm;
use NetherGames\NGEssentials\player\cosmetics\traits\SoundCosmeticTrait;
use NetherGames\NGEssentials\player\cosmetics\types\Cosmetic;
use pocketmine\player\Player;

class BedBreakSoundsCosmetic extends Cosmetic
{
    use SoundCosmeticTrait;

    public function getName(): string
    {
        return 'Bed Break Sounds';
    }

    public function getCrateAnimation(): string
    {
        return 'animation.ng.lobby.crate.bed_break_sound';
    }
