...
use NetherGames\NGEssentials\entity\pets\swimming\SwimmingTrait;
use pocketmine\nbt\tag\CompoundTag;

class SwimmingMonster extends Monster implements IPetEntity
{
    use SwimmingTrait {
        SwimmingTrait::initPetData as private baseInitPetData;
    }
