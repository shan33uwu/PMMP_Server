...
class ElephantPet extends Animal implements IPetEntity
{
    use WalkingPetTrait, CustomGeometryTrait {
        CustomGeometryTrait::sendSpawnPacket insteadof WalkingPetTrait;
    }

    public function getSkin(): Skin
    {
        return SkinStore::getInstance()->lazyLoad("pets", "elephant", "ElephantPet", "geometry.pets.elephant");
    }
