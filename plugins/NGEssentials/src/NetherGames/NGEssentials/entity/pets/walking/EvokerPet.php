...
class EvokerPet extends Monster implements IPetEntity
{
    use WalkingPetTrait {
    ...
    protected function initPetData(CompoundTag $nbt): void
    {
        ...
        $this->getNetworkProperties()->setGenericFlag(EntityMetadataFlags::EVOKER_SPELL, Utils::getRandomFloat() < 0.5);
    }
