...
class BouncingPetNavigator extends LazyPathFindingNavigator
{
        ...
        parent::__construct(
            ...
            (new PathFindingNavigator(
                ...
                new AStarPathFindingAlgorithm(
                    ...
                    new DefaultNeighborResolver((int)(3 + ($holder->getMaxHealth() / 2)), $holder),
                    16
    ...
    {
        return (int)(!$this->shouldUsePathfinding()) * $this->holder->getSize()->getWidth() * 0.25;
    }
