...
use NetherGames\NGEssentials\item\component\AllowOffHandComponent;
use NetherGames\NGEssentials\item\component\ArmorComponent;
use NetherGames\NGEssentials\item\component\CanDestroyInCreativeComponent;
use NetherGames\NGEssentials\item\component\CooldownComponent;
use NetherGames\NGEssentials\item\component\CreativeCategoryComponent;
use NetherGames\NGEssentials\item\component\CreativeGroupComponent;
use NetherGames\NGEssentials\item\component\DisplayNameComponent;
use NetherGames\NGEssentials\item\component\DurabilityComponent;
use NetherGames\NGEssentials\item\component\FoodComponent;
use NetherGames\NGEssentials\item\component\FuelComponent;
use NetherGames\NGEssentials\item\component\HandEquippedComponent;
use NetherGames\NGEssentials\item\component\IconComponent;
...
use NetherGames\NGEssentials\item\component\ProjectileComponent;
use NetherGames\NGEssentials\item\component\RenderOffsetsComponent;
use NetherGames\NGEssentials\item\component\ThrowableComponent;
use NetherGames\NGEssentials\item\component\UseAnimationComponent;
use NetherGames\NGEssentials\item\component\UseDurationComponent;
use NetherGames\NGEssentials\item\component\WearableComponent;
...
trait ItemComponentsTrait
{
    ...
    public function getComponents(int $protocolId): CompoundTag
    {
        $components = CompoundTag::create();
        $properties = CompoundTag::create();

        foreach ($this->components as $componentName => $component) {
            ($component->isProperty() ? $properties : $components)->setTag($componentName, $component->getValue($protocolId));
        }
