...
use conquests\shops\form\UpgraderForm;
...
final class Upgrader
{
    ...
    public function send(Player $player, CQTeam $team, bool $chestUI): void
    {
        if ($chestUI) {
    ...
    public function queue(Player $player, CQTeam $team, Trap $trap, int $slot): bool
    {
        /** @var NGPlayer $player */
    ...
    public function upgrade(Player $player, CQTeam $team, Upgrade $upgrade, int $level): bool
    {
        /** @var NGPlayer $player */
