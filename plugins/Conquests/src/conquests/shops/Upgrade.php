 ...
 * @method static self FLAG_PICKUP_SPEED()
 * @method static self FLAG_WEIGHT()
...
final class Upgrade
{
    ...
    protected static function setup(): void
    {
        ...
        self::register(
            registryName: "flag_pickup_speed",
            name: "Flag Pickup Speed",
            description: "Your team will pick up flags faster!",
            item: VanillaBlocks::WALL_BANNER()->setColor(DyeColor::LIGHT_BLUE())->asItem(),
            iconUrl: "textyres/blocks/loom_top",
            tiers: [
                1 => new UpgradeTier(
                    description: "Applies a 15% flag pickup speed!",
                    cost: 4,
                    teamCost: 6,
                    tieredText: "Tier 1: 15% Flag Pickup Speed" . TextFormat::GRAY . ", " . TextFormat::AQUA . UpgraderMenu::PRICE_SEARCH_PATTERN . " Diamonds"
                ),
                2 => new UpgradeTier(
                    description: "Applies a 30% flag pickup speed!",
                    cost: 6,
                    teamCost: 10,
                    tieredText: "Tier 2: 30% Flag Pickup Speed" . TextFormat::GRAY . ", " . TextFormat::AQUA . UpgraderMenu::PRICE_SEARCH_PATTERN . " Diamonds"
                )
            ]
        );
        self::register(
            registryName: "flag_weight",
            name: "Flag Weight",
            description: "Your team's flag will be heavier and slow enemies down!",
            item: VanillaBlocks::ANVIL()->asItem(),
            iconUrl: "textyres/blocks/netherite_block",
            tiers: [
                1 => new UpgradeTier(
                    description: "Increases your flag weight to slow enemies carrying it down!",
                    cost: 6,
                    teamCost: 8
                )
            ]
