...
final class ShopForm
{
    ...
    public function sendCategory(Player $player, CQTeam $team, ShopCategory $category, string $message = ""): void
    {
        $form = FormManager::createSimpleForm($player);
        if ($form === null) {
            return;
    ...
    public function createButtonFromShopItem(Player $player, CQTeam $team, ShopCategory $category, ShopItem $shopItem): Button
    {
        switch (true) {
            ...
            default:
                ...
                return new ImageButton(
                    ...
                    callable: function (Player $player) use ($team, $category, $shopItem, $costAmount) {
                        ...
                        if ($shopItem instanceof SlideableShopItem && NGEssentials::getInstance()->getPlayerData()->getGameSettings()->getBool($player, GameSettings::CQ_SHOP_SLIDER)) {
    ...
    public function sendSliderForm(Player $player, CQTeam $team, ShopCategory $category, ShopItem $shopItem, int $cost, int $balance): void
    {
