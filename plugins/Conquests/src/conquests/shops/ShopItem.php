...
class ShopItem
{
     ...
     */
    public function canPurchase(Player $player, CQTeam $team, ?int $multiplier = null): bool
    {
    ...
    private function mapItemForPurchase(Item $item, Player $player, CQTeam $team, ?int $multiplier = null): Item
    {
