...
use conquests\shops\cost\ItemCost;
    ...
    protected static function setup(): void
    {
        self::register(
            ...
            items: [
                new SlideableShopItem(
                    ...
                    itemModifierFn: function (Item $item, Player $player, CQTeam $team): Item {
                        /** @var Wool $block */
                        $block = $item->getBlock();
                ...
                new SlideableShopItem(
                    name: "Stained Clay",
                    value: VanillaBlocks::STAINED_CLAY()->asItem()->setCount(16),
                    iconPath: "textures/blocks/hardened_clay",
                ...
                new SlideableShopItem(
                    ...
                    description: "Solid block to defend your bed."
                ),
                new SlideableShopItem(
                    name: "Oak Planks",
                ...
                new SlideableShopItem(
                    name: "Obsidian",
                    value: VanillaBlocks::OBSIDIAN()->asItem()->setCount(8),
        ...
        self::register(
            ...
            items: [
                new ShopItem(
                    ...
                    replaceFn: function (Item $item, Player $player, CQTeam $team): void {
        ...
        self::register(
            ...
            items: [
                new ShopItem(
                    ...
                    iconPath: "textures/items/chainmail_boots",
                    cost: new ItemCost(CostType::IRON(), 20),
                    purchaseValidatorFn: function (ShopItem $item, Player $player, CQTeam $team): ?string {
                    ...
                    onPurchase: function (ShopItem $item, Player $player, CQTeam $team): void {
                        $value = $item->getValue();
                ...
                new UpgradeableShopItem(
                    ...
                    tiers: [
                        new ShopItem(
                            ...
                            cost: new ItemCost(CostType::IRON(), 5),
                        ...
                        new ShopItem(
                            ...
                            cost: new ItemCost(CostType::GOLD(), 8),
        ...
        self::register(
            ...
            items: [
                new ShopItem(
                    name: "Speed Potion",
                    value: CQItems::SWIFTNESS_POTION(),
                ...
                new ShopItem(
                    name: "Jump Potion",
                    value: CQItems::STRONG_LEAPING_POTION(),
                ...
                new ShopItem(
                    ...
                    value: CQItems::INVISIBILITY_POTION(),
                    iconPath: "textures/items/potion_bottle_moveSpeed",
                ...
                new ShopItem(
                    ...
                    value: CQItems::LEVITATION_POTION(),
                    iconPath: "textures/items/potion_bottle_levitation",
                    cost: new ItemCost(CostType::EMERALD(), 2),
                    description: "Take flight for " . CQItems::LEVITATION_DURATION . " seconds!"
                ),
            ]
        );
        self::register(
            ...
            items: [
                ...
                new ShopItem(
                    ...
                    cost: new ItemCost(CostType::GOLD(), 4, 5),
        ...
        self::register(
            ...
            items: [
                ...
                new ShopItem(
                    ...
                    iconPath: "textures/blocks/tnt_side",
                    cost: new ItemCost(CostType::GOLD(), 4, 6),
                    description: "Instantly ignites! Great for destroying defences fast!"
                ),
                new ShopItem(
                    name: "Bridge Builder",
                    value: CQItems::BRIDGE_EGG(),
                    iconPath: "textures/items/spawn_egg",
                    cost: new ItemCost(CostType::GOLD(), 5),
                ...
                new ShopItem(
                    ...
                    cost: new ItemCost(CostType::EMERALD(), 5),
