...
class BridgeEgg extends Living
{
    ...
    private CQArena $arena;
    private ?CQTeam $team = null;
    ...
    public function __construct(Location $location, private int $blocks)
    {
        ...
        if (($arena = Conquests::getInstance()->getArenaByWorld($this->getWorld())) instanceof CQArena) {
            $this->arena = $arena;
        } else {
    ...
    public function attack(EntityDamageEvent $source): void
    {
        ...
        if ($damagerTeam instanceof CQTeam) {
    ...
    private function terminateBridge(): void
    {
        ...
        $item = CQItems::BRIDGE_EGG($this->blocks);
