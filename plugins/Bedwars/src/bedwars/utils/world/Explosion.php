...
class Explosion extends \pocketmine\world\Explosion
{
    ...
    public function __construct(Position $center, float $size, private BWArena $arena, protected Entity|Block|null $what = null, private bool $showParticle = true, private bool $setOnFire = false, private float $maxDamage = Limits::INT32_MAX)
    {
