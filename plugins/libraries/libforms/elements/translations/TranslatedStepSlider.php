...
class TranslatedStepSlider extends TranslatedElement
{
    /**
     * @param string[] $steps
     */
    public function __construct(string $text, array $parameters, private array $steps, private int $default = -1, ?Closure $callable = null, bool $callbackOnDefault = false)
    {
