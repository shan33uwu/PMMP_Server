...
class TranslatedDropdown extends TranslatedElement
{
    /**
     * @param string[] $options
     */
    public function __construct(string $text, array $parameters, private array $options, private int $default = -1, ?Closure $callable = null, bool $callbackOnDefault = false)
    {
