...
class TranslatedToggle extends TranslatedElement
{
    public function __construct(string $text, array $parameters, private bool $default = false, ?Closure $callable = null, bool $callbackOnDefault = false)
    {
