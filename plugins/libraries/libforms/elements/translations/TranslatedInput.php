...
class TranslatedInput extends TranslatedElement
{
    public function __construct(string $text, array $parameters, private string $placeHolder, private string $default = '', ?Closure $callable = null, bool $callbackOnDefault = false)
    {
